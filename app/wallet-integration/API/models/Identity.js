...
export default class Identity {
    ...
    encrypt(seed){ if(!this.isEncrypted()) this.privateKey = CryptoJS.AES.encrypt(this.privateKey, seed); }
    decrypt(seed){ if(this.isEncrypted()) this.privateKey = CryptoJS.AES.decrypt(this.privateKey, seed); }
