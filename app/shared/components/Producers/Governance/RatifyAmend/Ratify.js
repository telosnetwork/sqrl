...
import GovernanceRatifyAmendRatifyVote from './Ratify/Vote';

class GovernanceRatifyAmendRatify extends Component<Props> {
  approve = (proposal) => {
    ...
    return (
      <React.Fragment>
        ...
        <Segment attached>
          ...
          <GovernanceRatifyAmendRatifyVote
...
export default translate('tools')(GovernanceRatifyAmendRatify);
