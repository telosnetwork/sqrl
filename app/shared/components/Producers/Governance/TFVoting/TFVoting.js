...
import GovernanceTFVotingCandidatesTable from './Table';
import GlobalTransactionModal from '../../../Global/Transaction/Modal';

class GovernanceTFVotingTFVoting extends Component<Props> {
  constructor(props) {
    super(props);
    this.state = {
      amount: 100,
        ...
        <Segment attached>
          ...
          }
          {
            [(
              <Visibility
                continuous
                key="TFVotingCandidatesTable"
                fireOnMount
                onBottomVisible={this.loadMore}
                once={false}
              >
                <GovernanceTFVotingCandidatesTable
...
export default translate('tools')(GovernanceTFVotingTFVoting);
