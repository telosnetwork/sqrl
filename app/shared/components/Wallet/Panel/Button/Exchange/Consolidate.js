...
class WalletPanelButtonExchangeConsolidate extends Component<Props> {
  props: Props;
  ...
  render() {
    ...
    return (
      <GlobalTransactionModal
        ...
        button={{
          color: 'blue',
          content: t('rex_consolidate', {tokenSymbol:settings.blockchain.tokenSymbol}),
          fluid: true,
          icon: 'microchip'
        }}
        content={(
        ...
        icon="microchip"
        title={t('rex_consolidate_title', {tokenSymbol:settings.blockchain.tokenSymbol})}
        settings={settings}
        system={system}
      />
    );
...
export default translate('exchange')(WalletPanelButtonExchangeConsolidate);
