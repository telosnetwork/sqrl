              ...
              <Header textAlign="center">
                <font color="green">
                  <Icon name="microchip" />{t('rex_withdraw_about_to', 
                    {withdrawalAmount: withdrawalAmount.toFixed(4), tokenSymbol: settings.blockchain.tokenSymbol})}
                </font>
                <Header.Subheader>
                  ({t('rex_you_will_have')} {balanceDifference.toFixed(4)} {t('rex_withdraw_balance_after', {tokenSymbol:settings.blockchain.tokenSymbol})})
                </Header.Subheader>
              </Header>
            </Segment>
          </Segment.Group>
