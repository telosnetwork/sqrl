...
class WalletPanelFormExchangeFromSavingsStats extends Component<Props> {
        ...
        <Segment>
          ...
          <Segment>
            <Header textAlign="center">
              ...
              <Header.Subheader>
              {t('rex_savings_amount_savings_unavailable', {tokenSymbol:settings.blockchain.tokenSymbol})}
              </Header.Subheader>
            </Header>
          </Segment>
        </Segment.Group>
...
export default translate('exchange')(WalletPanelFormExchangeFromSavingsStats);
